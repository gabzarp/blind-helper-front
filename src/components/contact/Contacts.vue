      ...
      <div class="container pt-4 bg-white">
        <div class="row justify-content-center">
          <div v-if='user.email' class="col-10 px-0 pb-2">
            <router-link to='/create_contact' class='btn border-0 rounded-0 px-3 py-2 bg-blue text-white'>Create contact</router-link>
          </div>
            <table class="col-10">
...
export default {
  ...
  mounted () {
    this.axios
    .get('http://localhost:3001/contact-by-user/' + this.$session.get('id'))
